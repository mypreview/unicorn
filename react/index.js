...
export { default as doubleChevronDown } from './library/double-chevron-down';
export { default as doubleChevronLeft } from './library/double-chevron-left';
export { default as doubleChevronRight } from './library/double-chevron-right';
export { default as doubleChevronUp } from './library/double-chevron-up';
